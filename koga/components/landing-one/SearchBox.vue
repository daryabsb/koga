...
<form>
  <div role="search" class="sbx-airbnb__wrapper">
    <input type="search" name="search" placeholder="Search your website" autocomplete="off" required="required" class="sbx-airbnb__input">
    <button type="submit" title="Submit your search query." class="sbx-airbnb__submit">
...
export default {
   head: {
    ...
    link: [
        { rel: 'stylesheet', href: '/bootstrap/css/search.css' }
      ],
  }
}
</script>